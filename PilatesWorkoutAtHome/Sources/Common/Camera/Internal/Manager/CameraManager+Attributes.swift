...
struct CameraManagerAttributes {
    ...
    var grid: Grid = .threeByThree
    var imageAspectRatio: ImageAspectRatio = .fourThree
    var captureDelay: CaptureDelay = .off
    var sound: Sound = .on
    var focus: Focus = .manual
    var mirror: MirrorType = .off
    var vibrate: Vibrate = .on
